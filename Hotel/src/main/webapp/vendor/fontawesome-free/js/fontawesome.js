...
(function () {
    ...
    if (DOCUMENT && typeof DOCUMENT.querySelector === 'function') {
        var attrs = [['data-family-prefix', 'familyPrefix'], ['data-replacement-class', 'replacementClass'],
            ['data-auto-replace-svg', 'autoReplaceSvg'], ['data-auto-add-css', 'autoAddCss'], ['data-auto-a11y', 'autoA11y'],
    ...
    function transformForSvg(_ref) {
        ...
        var innerScale = 'scale(' + transform.size / 16 * (transform.flipX ? -1 :
                                                           1) + ', ' + transform.size / 16 * (transform.flipY ? -1 : 1) + ') ';
    ...
    function transformForCss(_ref2) {
        ...
        val += 'scale(' + transform.size / d * (transform.flipX ? -1 : 1) + ', ' + transform.size / d * (transform.flipY ? -1 :
                                                                                                         1) + ') ';
    ...
    function makeInlineSvgAbstract(params) {
        ...
        var attrClass = [config.replacementClass, iconName ? config.familyPrefix + '-' + iconName : '',
    ...
    var DOT = {
        ...
        children: [{tag: 'animate', attributes: _extends({}, ANIMATION_BASE, {attributeName: 'r', values: '28;14;28;28;14;28;'})},
                ...
                [':before', ':after'].forEach(function (pos) {
                    ...
                    if (alreadyProcessedPseudoElement && !fontFamily) {
                        ...
                        var prefix = ~['Light', 'Regular', 'Solid', 'Brands'].indexOf(fontFamily[1]) ?
                                     STYLE_TO_PREFIX[fontFamily[1]] : FONT_WEIGHT_TO_PREFIX[fontWeight];
    ...
    function resolveIcons(next) {
        return function (maybeIconDefinition) {
            ...
            var iconDefinition = (maybeIconDefinition || {}).icon ? maybeIconDefinition :
