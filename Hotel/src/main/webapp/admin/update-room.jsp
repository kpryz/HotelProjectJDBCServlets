    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                ...
                <section id="contact"
                         class="update-room-section admin-crud-section header-contact d-flex align-items-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <h2 class="section-heading text-uppercase mb-md-5 mb-sm-4">Update room</h2>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="contactForm" action="update-room" method="post" novalidate="novalidate">
                                    <div class="row d-flex justify-content-center">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="roomType"
                                                       placeholder="Room type *" required="required"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" type="number" min="0" max="1000" name="oldRoomNumber"
                                                       placeholder="Old room number *" required="required"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" type="number" min="0" max="1000" name="newRoomNumber"
                                                       placeholder="New room number *" required="required"
                                                       data-validation-required-message="Please enter room number.">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                        </div>
