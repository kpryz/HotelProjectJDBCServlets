    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                ...
                <section id="contact"
                         class="add-visa-section admin-crud-section header-contact d-flex align-items-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <h2 class="section-heading text-uppercase mb-md-5 mb-sm-4">Register visa</h2>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="contactForm" class="form-validate" action="add-visa" method="post"
                                      novalidate>
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="ownerEmail" list="datalist"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="visaNumber"
                                                       placeholder="Visa number *" required="required"
