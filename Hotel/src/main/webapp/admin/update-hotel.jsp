    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                ...
                <section id="contact"
                         class="update-hotel-section admin-crud-section header-contact d-flex align-items-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <h2 class="section-heading text-uppercase mb-md-5 mb-sm-4">Update hotel</h2>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="contactForm" method="post" action="update-hotel"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="imageUrl"
                                                       ...
                                                       data-validation-required-message="Please enter hotel imageUrl url">
                                                <p class="help-block text-danger"></p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" type="text" list="hotelNameDatalist" name="oldName"
                                                       placeholder="Old hotel name *" required="required"
                                                       data-validation-required-message="Please enter old hotel name.">
                                                <p class="help-block text-danger"></p>
                                                <datalist id="hotelNameDatalist">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="newName"
                                                       placeholder="New hotel name *" required="required"
                                                       data-validation-required-message="Please enter new hotel name.">
                                                <p class="help-block text-danger"></p>
